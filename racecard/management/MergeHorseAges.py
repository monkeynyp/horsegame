...
curr_hist_df = pd.read_csv('/Users/louisngai/HorsePredictLocal/curr_hist_df_m_3.csv')
horse_ages = pd.read_csv('/Users/louisngai/HorsePredictLocal/horse_ages202509.csv')

for i in range(1, 12):
    # Read in the current race CSV file
    curr_race_df = pd.read_csv(f'/Users/louisngai/HorsePredictLocal/current_race_{i}.csv')
    
    # Merge the dataframes on HorseName
    merged_df = pd.merge(curr_race_df, horse_ages, on='HorseName', how='left')
    
    # Save the merged dataframe to a new CSV file
    merged_df.to_csv(f'/Users/louisngai/HorsePredictLocal/new_current_race_{i}.csv', index=False)
...
# Save the merged dataframe to a new CSV file
merged_df.to_csv('/Users/louisngai/HorsePredictLocal/curr_hist_df_m_5.csv', index=False)